$(function () {
    ...
    $.ajax({
        type: 'GET',
        url: '/get_echarts_data',
        dataType: 'json',
        success: function(res){
            //行业和职位数
            echarts_1(res['echart_1']);
            //薪资
            echarts_2(res['echart_2']);
            // 工作经验
            echarts_5(res['echart_5']);
            //公司规模
            echarts_6(res['echart_32']);
            //公司融资类型
            echarts_31(res['echart_31']);
            //学历
            echarts_32(res['echart_6']);
            map(res['map']);
        }
    });
            ...
            series: [
                {
                    ...
                    center: ['50%', '42%'],
                    radius: ['40%', '60%'],
                    color: ['#2F4553', '#C33233', '#D58268', '#60A0A7', '#73A084', '#90C8AF', '#EEDE80', '#E79D89', '#35A1D7'],
                    label: {show: false},
